...
public class newfilm extends AppCompatActivity {
    ...
    class MyTask extends AsyncTask<Void, Void, ArrayList<String[]>> {
        ...
        protected ArrayList<String[]> doInBackground(Void... params) {
            ...
            try {
                URL githubEndpoint = new URL(Data.allTheatre);
                myConnection =
...
//            tvInfo.setText("End");
    ...
    class ClAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (view == null) {
                view = lInflater.inflate(R.layout.adapter_newfilm, parent, false);
            };
    ...
    class MyTaskN extends AsyncTask<String, Void, String > {
        ...
        protected String doInBackground(String... params) {
            ...
            JSONObject obj=null;
            try {
                URL githubEndpoint = new URL(Data.newFilm);
                myConnection =
                        (HttpURLConnection) githubEndpoint.openConnection();
            } catch (MalformedURLException e) {
                e.printStackTrace();
...
//                    mttf.get(m).execute(st[1],result);
    ...
    class MyTaskTF extends AsyncTask<JSONArray, Void, String > {
        ...
        protected String doInBackground(JSONArray... jsonArrays) {
            ...
            JSONObject obj=null;
            try {
                URL githubEndpoint = new URL(Data.newTheatre_Film);
                myConnection =
                        (HttpURLConnection) githubEndpoint.openConnection();
            } catch (MalformedURLException e) {
                e.printStackTrace();
